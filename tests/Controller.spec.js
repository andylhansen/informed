  ...
  describe('api', () => {
    ...
    describe('reset', () => {
      it('resets the state', () => {
        ...
        controller.register(
          'firstname',
          getFieldController('firstname', controller.api, {
            initialValue: 'Joe'
          })
        );
    ...
    describe('notify', () => {
      it('should notify other fields about changes and call their validators', () => {
        ...
        controller.register(
          'foo',
          getFieldController('greeting', controller.api, { validate: spy2 })
        );
        controller.register(
          'bar',
          getFieldController('greeting', controller.api, { validate: spy3 })
        );
        controller.api.setValue('greeting', 'hello');
      ...
      it('should throw error when field does not exist', () => {
        ...
        assert.throws(
          () => controller.api.setValue('greeting', 'hello'),
          Error,
          'Cant notify field baz as it does not exist!'
        );
      });
    });
  });
